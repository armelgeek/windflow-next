    ...
    return (
        <section className="pt-20 pb-32 px-6">
            <div className="max-w-5xl mx-auto text-center">
                <h1 className="text-5xl md:text-6xl font-bold mb-6">Créez des sites web sans code</h1>
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
                    <button className="px-8 py-3 bg-black text-white text-lg rounded-md hover:bg-gray-800 transition-all">
                ...
                <div className="relative">
                    ...
                    <div className="relative border border-gray-200 rounded-lg shadow-xl overflow-hidden">
                        <img src="/api/placeholder/1200/600" alt="Interface du constructeur visuel" className="w-full" />
